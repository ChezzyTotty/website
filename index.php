...
<div id="menu">
    ...
    if (isset($_SESSION['username'])) {
        ...
        echo '<a href="logreg/profil.php">Profil</a>';
        echo '<a href="logreg/ayarlar.php">Ayarlar</a>';
        echo '<a href="logreg/logout.php">Çıkış Yap</a>';
        echo '</div>';
        echo '</div>';
    } else {
        // Kullanıcı giriş yapmamışsa
        echo '<a href="logreg/login.php" class="menu-link">Giriş</a>';
        echo '<a href="logreg/registration.php" class="menu-link">Kayıt</a>';
    }
    ?>
</div>
