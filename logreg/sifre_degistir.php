...
if (mysqli_num_rows($result) == 1) {
    ...
    if (password_verify($current_password, $stored_password)) {
        ...
        if ($new_password === $confirm_password) {
            ...
            if ($update_result) {
                echo "<div class='success-message'>Şifre başarıyla güncellendi. <a href='../index.php'>Profil'e dön</a></div>";
            } else {
                echo "<div class='error-message'>Şifre güncelleme işlemi sırasında bir hata oluştu. Lütfen tekrar deneyin.<a href='profil.php'>Profil'e dön</a></div>";
            }
        } else {
            echo "<div class='error-message'>Yeni şifre ve doğrulama şifresi eşleşmiyor. Lütfen tekrar deneyin.<a href='profil.php'>Profil'e dön</a></div>";
        }
    } else {
        echo "<div class='error-message'>Mevcut şifre yanlış. Lütfen doğru bir şekilde girin. <a href='profil.php'>Profil'e dön</a></div>";
    }
} else {
